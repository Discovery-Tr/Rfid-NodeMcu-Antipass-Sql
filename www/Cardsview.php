...
$Cards_view = NULL; // Initialize page object first

class cCards_view extends cCards {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "Cardslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "Cardslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "Cardslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($Cards_view)) $Cards_view = new cCards_view();

// Page init
$Cards_view->Page_Init();

// Page main
$Cards_view->Page_Main();
...
// Page object
var Cards_view = new ew_Page("Cards_view");
Cards_view.PageID = "view"; // Page ID
var EW_PAGE_ID = Cards_view.PageID; // For backward compatibility

// Form object
var fCardsview = new ew_Form("fCardsview");

// Form_CustomValidate event
fCardsview.Form_CustomValidate = 
...
fCardsview.ValidateRequired = true;
<?php } else { ?>
fCardsview.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$Cards_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fCardsview" id="fCardsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="Cards">
<table class="ewGrid"><tr><td>
<table id="tbl_Cardsview" class="table table-bordered table-striped">
...
<?php echo $Cards->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Cards->CardId->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Cards->Name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Cards->Surname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Cards->Phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($Cards->Active->Visible) { // Active ?>
	<tr id="r_Active">
		<td><span id="elh_Cards_Active"><?php echo $Cards->Active->FldCaption() ?></span></td>
...
<?php echo $Cards->Active->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
