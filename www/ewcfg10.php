...
define("EW_PROJECT_NAME", "KGS", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{A465A203-2D9F-40EC-9F78-053F2F1FA743}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'vYbPcyrqsr3zMNmT', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/KGS.css", TRUE); // Project stylesheet file name
define("EW_CHARSET", "iso-8859-9", TRUE); // Project charset
...
define("EW_CODEPAGE", 28599, TRUE); // Code page
 ...
 * details.
 */
define("EW_ENCODING", "ISO-8859-9", TRUE); // Character encoding
 ...
 */
define("EW_MYSQL_CHARSET", "latin5", TRUE);
