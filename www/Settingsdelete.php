...
?>
<form name="fSettingsdelete" id="fSettingsdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_Settingsdelete" class="ewTable ewTableSeparate">
<?php echo $Settings->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($Settings->Item->Visible) { // Item ?>
		<td><span id="elh_Settings_Item" class="Settings_Item"><?php echo $Settings->Item->FldCaption() ?></span></td>
<?php } ?>
<?php if ($Settings->Value->Visible) { // Value ?>
		<td><span id="elh_Settings_Value" class="Settings_Value"><?php echo $Settings->Value->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($Settings->Item->Visible) { // Item ?>
		<td<?php echo $Settings->Item->CellAttributes() ?>>
<span id="el<?php echo $Settings_delete->RowCnt ?>_Settings_Item" class="control-group Settings_Item">
<span<?php echo $Settings->Item->ViewAttributes() ?>>
<?php echo $Settings->Item->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($Settings->Value->Visible) { // Value ?>
		<td<?php echo $Settings->Value->CellAttributes() ?>>
<span id="el<?php echo $Settings_delete->RowCnt ?>_Settings_Value" class="control-group Settings_Value">
<span<?php echo $Settings->Value->ViewAttributes() ?>>
<?php echo $Settings->Value->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
