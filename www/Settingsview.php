...
class cSettings_view extends cSettings {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["Item"] <> "") {
			$this->RecKey["Item"] = $_GET["Item"];
			$KeyUrl .= "&amp;Item=" . urlencode($this->RecKey["Item"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Item"] <> "") {
				...
				$this->RecKey["Item"] = $this->Item->QueryStringValue;
			} else {
...
<?php if (!$Settings_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fSettingsview" id="fSettingsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="Settings">
<table class="ewGrid"><tr><td>
<table id="tbl_Settingsview" class="table table-bordered table-striped">
<?php if ($Settings->Item->Visible) { // Item ?>
	<tr id="r_Item">
		<td><span id="elh_Settings_Item"><?php echo $Settings->Item->FldCaption() ?></span></td>
...
<?php echo $Settings->Item->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($Settings->Value->Visible) { // Value ?>
	<tr id="r_Value">
		<td><span id="elh_Settings_Value"><?php echo $Settings->Value->FldCaption() ?></span></td>
...
<?php echo $Settings->Value->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
