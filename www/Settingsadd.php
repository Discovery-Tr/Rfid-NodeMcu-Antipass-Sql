...
class cSettings_add extends cSettings {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["Item"] != "") {
				$this->Item->setQueryStringValue($_GET["Item"]);
				$this->setKey("Item", $this->Item->CurrentValue); // Set up key
			} else {
				$this->setKey("Item", ""); // Clear key
	...
	function ValidateForm() {
		...
		if (!$this->Item->FldIsDetailKey && !is_null($this->Item->FormValue) && $this->Item->FormValue == "") {
			ew_AddMessage($gsFormError, $Language->Phrase("EnterRequiredField") . " - " . $this->Item->FldCaption());
		}
	...
	function AddRow($rsold = NULL) {
		...
		if ($bInsertRow && $this->ValidateKey && $this->Item->CurrentValue == "" && $this->Item->getSessionValue() == "") {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_HasValue(elm))
				return this.OnError(elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($Settings->Item->FldCaption()) ?>");
			elm = this.GetElements("x" + infix + "_Value");
			if (elm && !ew_HasValue(elm))
				return this.OnError(elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($Settings->Value->FldCaption()) ?>");
...
?>
<form name="fSettingsadd" id="fSettingsadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="Settings">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_Settingsadd" class="table table-bordered table-striped">
<?php if ($Settings->Item->Visible) { // Item ?>
	<tr id="r_Item">
		<td><span id="elh_Settings_Item"><?php echo $Settings->Item->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $Settings->Item->CellAttributes() ?>>
<span id="el_Settings_Item" class="control-group">
<input type="text" data-field="x_Item" name="x_Item" id="x_Item" size="30" maxlength="50" placeholder="<?php echo $Settings->Item->PlaceHolder ?>" value="<?php echo $Settings->Item->EditValue ?>"<?php echo $Settings->Item->EditAttributes() ?>>
</span>
<?php echo $Settings->Item->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($Settings->Value->Visible) { // Value ?>
	<tr id="r_Value">
		<td><span id="elh_Settings_Value"><?php echo $Settings->Value->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $Settings->Value->CellAttributes() ?>>
<span id="el_Settings_Value" class="control-group">
<input type="text" data-field="x_Value" name="x_Value" id="x_Value" size="30" maxlength="50" placeholder="<?php echo $Settings->Value->PlaceHolder ?>" value="<?php echo $Settings->Value->EditValue ?>"<?php echo $Settings->Value->EditAttributes() ?>>
</span>
<?php echo $Settings->Value->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</td></tr></table>
